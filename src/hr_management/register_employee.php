...
$result = mysqli_query($con, $role_query);
$role_array = mysqli_fetch_all($result,MYSQLI_ASSOC);
$role_count = count($role_array);
//print_r($dept_array);
//echo "<br>Dept Id = ".$dept_array[2]['dept_id'];
//echo "<br>Dept Name = ".$dept_array[2]['dept_name'];
                            ...
                            <div class="tab-content" style="min-height: 300px;">
                                <div class="active tab-pane" id="general-info"  style="min-height:250px;">
                                    <div class="row">  
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="pin_zip_code" name="pin_zip_code" placeholder="Pincode">
                                        </div>
                                    ...
                                    <div class="row">  
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" id="emp_designation" name="emp_designation">
                                                ...
                                                <option value=" OPD Nurse"> OPD Nurse</option>
                                                <option value=" IPD Doctor<"> IPD Doctor</option>
                                                <option value=" IPD Nurse"> IPD Nurse</option>
                                ...
                                <div class="tab-pane" id="approval"  style="min-height:250px;">
                                    <div class="row col-md-12">
                                        ...
                                        <h3>For Login Actions</h3>

                                        <div class="checkbox form-group col-md-12">
                                            <label>
                                                <input type="checkbox" name="add_in_users"> Register for Login?
                                            </label>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="register_employee_password1">Login Code</label>
                                            <input type="text" class="form-control" id="login_name1" name="login_name1" placeholder="Password">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="register_employee_password1">Password</label>
                                            <input type="password" class="form-control" id="password1" name="password1" placeholder="Password"> 
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="register_employee_dept_id">Role Attached</label>
                                            <select type="text" class="form-control" id="role_id" name="role_id">
                                                <option value="">Select Role</option>
                                                <?php
                                                for ($i = 0; $i < $role_count; $i++) {
                                                    echo '<option value="' . $role_array[$i]['role_id'] . '">' . $role_array[$i]['role_name'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>                                        
