...
if (isset($_POST['submit']) && empty($_GET['action'])) {
    ...
    if (mysqli_query($con, $table_query)) {
        echo "<script>alert('New record is added successfully to $table master');window.location.href='dashboard.php?page=crud_tax_master';</script>";
    } else {
        echo "<script>alert('ERROR: 001 - This record can't be added ...');window.location.href='dashboard.php?page=crud_tax_master';</script>";
    }
    ...
    switch ($action) {
        case 'edit': 
            ...
            if (mysqli_query($con, $table_query)) {
                echo "<script>alert('Record No.$id is Updated successfully to $table');window.location.href='dashboard.php?page=crud_tax_master';</script>";
            } else {
                echo "<script>alert('ERROR: 001 - This record can't be added ...');window.location.href='dashboard.php?page=crud_tax_master';</script>";
            }
            break;
        case 'delete':
            ...
            if (mysqli_query($con, $table_query)) {
                echo "<script>alert('Record No.$id is Deleted successfully to $table');window.location.href='dashboard.php?page=crud_tax_master';</script>";
            } else {
                echo "<script>alert('ERROR: 001 - This record can't be added ...');window.location.href='dashboard.php?page=crud_tax_master';</script>";
            }
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                while ($tresult_array = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo '&nbsp;&nbsp<a onclick="return delFunction();"  class="btn btn-warning btn-flat btn-xs" href="dashboard.php?page=tax_master&action=delete&id='. $tresult_array['tax_id'] .'" >Delete</a>';
                                                    echo "</td>";
                                                    echo "<tr>";
                                                }
      ...
      <!--form id="crud_form" class="form-horizontal" role="form" action="src/accounts/take.php" method="post"-->
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <form class="form-horizontal" role="form" action="dashboard.php?page=crud_tax_master&action=edit" method="post">
                      <div class="col-md-12">
                          <div class="form-group">
