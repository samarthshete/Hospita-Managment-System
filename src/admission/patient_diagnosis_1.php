...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="new-user-form" action="update_patient_diagnosis.php" method="post">
                            ...
                            <div class="active tab-pane" id="patient-reporting"  style="min-height:450px;">
                                <div class="row">  
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" row="3" id="patient_complaint" name="patient_complaint"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 required ">Family History</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="family_details" name="family_details"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 required">Past History</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="past_history" name="past_history" rows="2" cols="30"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-md-3 required">Allergies</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="allergies" name="allergies" rows="2" cols="30"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label  col-md-3 required">Prev._Analysis</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="prev_analysis" name="prev_analysis" rows="2" cols="30"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label  col-md-3 required">Prev_Treatment</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="prev_treatment" name="prev_treatment" rows="2" cols="30"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-md-3 required">Prev_Test</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" id="prev_test" name="prev_test" rows="2" cols="30"></textarea>
                                        </div>
                                    </div>
                                </div>
            ...
            $test_required = $row['test_required'];-->
                            ...
                            <div class="tab-pane" id="doctoranalysis" style="min-height:450px;">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-10">
                                        <textarea row="3" class="form-control" id="analysis" name="analysis"></textarea>
                                    </div>
                                </div>
                                    <div class="form-group ">
                                        <label class="control-label col-md-2 required">Treatment</label>
                                        <div class="col-md-10">
                                            <textarea input type="text" class="form-control" id="treatment" name="treatment"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-md-2 required">Lab Tests<br> Needed</label>
                                        <div class="col-md-10">
                                            <textarea input type="text" class="form-control" id="lab _tests_needed" name="lab _tests_needed"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-2 required">Next Action <br>Planned</label>
                                        <div class="col-md-10">
                                            <textarea input type="text" class="form-control" id="next_action_planned" name="next_action_planned"></textarea>
                                        </div>
                                    </div>
        ...
        <div class="form-group col-xs-12 col-sm-6 col-lg-4 no-padding edusecArLangCss"> 
            <div class="col-xs-6"> 
                <button type="submit" class="btn btn-block btn-primary" width="60px;">Save Data</button>
            </div> 
            <div class="col-xs-6"> 
