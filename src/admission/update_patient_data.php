...
//echo "<br>Patient Master Query =".$patient_query;
if($result=  mysqli_query($con, $patient_query)){
    $queue_update_query="UPDATE queue_data SET actor_id='$dept_assigned',action_link='dashboard.php?page=preexam_patient_data&id=$patient_id',status='in process' WHERE patient_id='".$patient_id."'";
